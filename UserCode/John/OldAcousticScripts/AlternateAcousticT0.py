...
def T0finder(ev,
    ...
    # Depreciated in favor of AltAlternateAcousticT0.py
    print("***Using outdated AcousticT0 finding algorithm! Switch to AltAlternateAcousticT0.py for better results.")
