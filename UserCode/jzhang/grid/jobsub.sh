...
svn up
cd /bluearc/storage/recon/devel/code/SBCcode/UserCode/jzhang/grid
./tar_sbc_code.sh
...
RUN_LIST_FILE="/pnfs/coupp/persistent/runlists/SBC-17/list_1510952107"
...
jobsub_submit --group=coupp --resource-provides=usage_model=DEDICATED,OPPORTUNISTIC \
    ...
    -N $N \
    file:///bluearc/storage/recon/devel/code/SBCcode/UserCode/jzhang/grid/sbc_grid_wrapper.sh \
    $OPTION_TEXT \
    $EXE_DIR \
    $DATA_DIR \
    $CODE_DIR \
