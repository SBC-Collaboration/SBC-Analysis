...
if len(sys.argv) != 3:
    ...
    print('Usage: python convert.py <dir-where-merged_all.txt-is> <dir-where-raw-data-is>')
    exit()
...
try:
    ...
    print(raw.head())
    np.save(os.path.join(raw_directory, 'raw_events.npy'), raw)
except:
