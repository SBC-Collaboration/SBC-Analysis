...
comp_equalized = skimage.util.compare_images(img1, img1_equalized, method='checkerboard')
diff_rotated = skimage.util.compare_images(img1, img2, method='diff')
blend_rotated = skimage.util.compare_images(img1, img2, method='blend')
